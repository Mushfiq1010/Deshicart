...
return (
  <div className="bg-gradient-to-br from-teal-50 to-blue-100 min-h-screen">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {products.map((product) => (
            <div
              ...
              className="relative bg-white shadow-md rounded-lg p-4 transition hover:bg-indigo-50 hover:shadow-lg flex flex-col justify-between overflow-hidden"
            >
