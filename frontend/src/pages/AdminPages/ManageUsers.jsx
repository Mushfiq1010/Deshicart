...
return (
  <div className="p-6 bg-gradient-to-r from-teal-100 via-blue-200 to-indigo-300 min-h-screen">
      ...
      <>
        {topSellers.length > 0 && (
          <div className="max-w-7xl mx-auto mb-10">
            <h3 className="text-3xl font-bold text-white bg-gradient-to-r from-teal-400 to-blue-500 p-4 mb-6 text-center rounded-lg shadow-lg">
              🌟 Top Sellers
            </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {topSellers.map((seller, index) => (
                <div
                  ...
                  className="bg-teal-50 border border-teal-300 shadow-md rounded-lg p-5 relative"
                >
                  <div className="absolute -top-3 -left-3 bg-teal-500 text-white font-extrabold px-4 py-2 rounded-full shadow-lg text-xl">
                    #{index + 1}
                  </div>
