...
const OrderHistory = () => {
  ...
  return (
    <div className="p-6 flex flex-col items-center bg-gradient-to-r from-teal-100 via-green-100 to-blue-100 min-h-screen">
  <h2 className="text-4xl font-bold text-gray-800 mb-6">🛒 Order History</h2>
  {orders.length === 0 && <p className="text-lg text-gray-500">No orders found.</p>}

  <div className="mb-6 text-2xl font-semibold text-indigo-600">
  ...
  {orders.map((order) => (
    <div
      ...
      style={{
        backgroundColor: "#f0fdf4", // Soft greenish background for cards
      }}
    >
